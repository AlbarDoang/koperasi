...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://192.168.1.25/gas/gas_web/flutter_api/admin_update_user.php');
...
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'http://192.168.43.151/gas/gas_web/flutter_api/admin_update_user.php');
    'id' => $id,
