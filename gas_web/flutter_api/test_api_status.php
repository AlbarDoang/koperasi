...
$sql = "SELECT id_transaksi, id_anggota, status, keterangan, tanggal FROM transaksi ORDER BY tanggal DESC LIMIT 1";
...
if ($result && $result->num_rows > 0) {
    ...
    $api_sql = "SELECT id_transaksi, jenis_transaksi, jumlah, status, keterangan FROM transaksi WHERE id_anggota = ? ORDER BY tanggal DESC LIMIT 5";
