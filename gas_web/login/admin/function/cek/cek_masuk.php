...
$sql = 'SELECT *, SUM(jumlah) AS jumlah FROM t_masuk GROUP BY tanggal, no_masuk, nama, id_tabungan, kelas';
...
echo '<script>
	...
	<html>
		<head>
			<title>Total Transaksi Tabungan Masuk</title>
...
<?php
echo "<center><tr><b>Laporan Transaksi Tabungan Masuk</b></tr><br>";
echo "<tr><b>&nbsp;</b></tr>";
echo '<table border=1>
		<thead>
			<tr>
