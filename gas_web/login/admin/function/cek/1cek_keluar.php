...
$sql = 'SELECT *, SUM(jumlah) AS jumlah FROM t_keluar GROUP BY tanggal, no_keluar, nama, id_tabungan, kelas';
...
echo '<script>
	...
	<html>
		<head>
			<title>Total Transaksi Penarikan Tabungan</title>
...
<?php
echo "<center><tr><b>Laporan Transaksi Penarikan Tabungan</b></tr><br>";
echo "<tr><b>&nbsp;</b></tr>";
echo '<table border=1>
		<thead>
			<tr>
