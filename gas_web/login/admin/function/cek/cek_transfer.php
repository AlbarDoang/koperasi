...
$sql = 'SELECT *, SUM(nominal) AS nominal FROM t_transfer GROUP BY tanggal, no_transfer, nama_pengirim, id_pengirim, kelas_pengirim, nama_penerima, id_penerima, kelas_penerima';
...
echo '<script>
	...
	<html>
		<head>
			<title>Total Transaksi Transfer Tabungan</title>
...
<?php
echo "<center><tr><b>Laporan Transaksi Transfer Tabungan</b></tr><br>";
echo "<tr><b>&nbsp;</b></tr>";
echo '<table border=1>
		<thead>
			<tr>
