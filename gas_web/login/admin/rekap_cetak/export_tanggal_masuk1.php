...
//$filename = "Transaksi-Tabungan-Masuk-Pertanggal-(".$Tanggal1." - ".$Tanggal2.").xls";
...
$sql = 'SELECT *, SUM(jumlah) AS jumlah FROM t_masuk WHERE tanggal BETWEEN "'.$_POST['tgl_a'].'" AND "'.$_POST['tgl_b'].'" GROUP BY tanggal, no_masuk, nama, id_tabungan, kelas';
...
<?php
echo "<center><div align='center'><tr><b>Laporan Transaksi Tabungan Masuk <br>Pertanggal $Tanggal1 sampai $Tanggal2 </b></tr></div>";
   }
    echo "<br>";
echo '<table border="1">
        <thead>
...
echo '<tr class="total">
        <td colspan="5" align="center">Total Semua Tabungan Masuk</td>
