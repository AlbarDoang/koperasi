...
$filename = "Data-Detail-Jurusan-(".$nama_jurusan.").xls";
...
// header("Content-Disposition: attachment; filename=$filename");
    $query = mysqli_query($con, "SELECT * FROM kelas WHERE id_jur='$id_jur' ORDER BY rombel ASC");
    $no=1;?>
...
<?php
echo "<center><tr colspan='9'><b>Data Detail ".$nama_jurusan."</b></tr><br>";
echo "<tr><b>&nbsp;</b><br></tr>";
