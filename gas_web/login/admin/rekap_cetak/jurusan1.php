...
$filename = "Data-Tabungan-Jurusan.xls";
...
// header("Content-Disposition: attachment; filename=$filename");
    ...
    $query = mysqli_query($con, "SELECT * FROM jurusan ORDER BY id_jur ASC");
    $no=1;?>
...
<?php
echo "<center><tr colspan='9'><b>Data Tabungan Jurusan</b></tr><br>";
echo "<tr><b>&nbsp;</b><br></tr>";
    ...
    // Hitung Jumlah Siswa
    $res11= $con->query("SELECT SUM(saldo) AS saldo FROM pengguna WHERE id_jurusan='$r[id_jur]'");
