...
$sql = 'SELECT *, SUM(nominal_m) AS nominal_m, SUM(nominal_k) AS nominal_k FROM transaksi WHERE tanggal=DATE(NOW()) GROUP BY tanggal, no_masuk, no_keluar, nama, id_tabungan, kelas, kegiatan';
...
$filename = "Transaksi-Tabungan-Siswa-(".tgl_indo($hariini).").xls";
...
echo "<div align='center'><h2>Laporan Transaksi Tabungan Siswa Hari Ini</h2>";
echo "<tr><b>&nbsp;</b></tr>";
