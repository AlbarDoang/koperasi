...
// $filename = "Tabungan-(".$namaku.")-(".$Tanggal1." - ".$Tanggal2.").xls";
...
echo "<center><div align='center'>
        <h2>Laporan Transaksi Tabungan Siswa</h2>
        <h3>".$Tanggal1." sampai ".$Tanggal2."</h3>
    ";
echo '
    <table>
		<thead>
...
$sql = 'SELECT *, SUM(nominal_m) AS nominal_m, SUM(nominal_k) AS nominal_k FROM transaksi WHERE id_tabungan='.$id_tabungan.' AND tanggal BETWEEN "'.$_POST['tgl_a'].'" AND "'.$_POST['tgl_b'].'" GROUP BY tanggal, no_masuk, no_keluar, nama, id_tabungan, kelas, kegiatan';
...
echo '<tr class="total">
	...
	<tr class="subtotal">
		<td colspan="3" align="center">Total Saldo Tabungan Tanggal '.$Tanggal1.' s/d '.$Tanggal2.'</td>
