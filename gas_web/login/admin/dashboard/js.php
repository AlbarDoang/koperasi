...
<!-- SELECT2 JS (needs jQuery loaded first) -->
<script src="/gas/gas_web/assets/plugins/select2/js/select2.min.js"></script>

<!-- Dashboard local scripts (use absolute path so it resolves regardless of current page) -->
<script src="/gas/gas_web/login/admin/dashboard/dashboard.js"></script>
