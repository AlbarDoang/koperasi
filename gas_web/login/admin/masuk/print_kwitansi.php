...
window.print();
    ...
    <head>    
        ...
        <title>Kwitansi Setoran - Sistem Koperasi GAS</title>
                ...
                <div class="card-body">
                    <div class="clearfix">
                        <div class="float-start">
                            ...
                            <h3 class="card-title mb-0">#<?php echo $no_masuk ?></h3>
                        </div>
                        <div class="float-end">
                        ...
                        <table class="table invoice-summary">
                            <thead>
                                <tr>
                                    ...
                                    <address>
                                        <a href="#myMod" id="custId" data-bs-toggle="modal" data-id="<?php echo $row['no_masuk']; ?>" title="Klik Untuk Memperbesar">
                                        <img src="../../../assets/barcode/barcode.php?s=qr&d=<?php echo "$row[no_masuk]"?>&p=-8&h=100&w=100"></a><br>
                                        Scan Barcode
                                    </address>
                                    </th>
                                </tr>
                    ...
                    <div class="row">
                        <div class="col-lg-12 table-responsive">
                            <table class="table invoice-summary">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="text-uppercase" width="20%"><b>Jumlah Menabung</b></td>
                                        <td class="text-center">:</td>
                                        <td class="text-center"></td>
                                        <td class="text-left"><b>Rp. <?php echo format_ribuan($row['jumlah']) ?></b></td>
                                    </tr>
                                    <tr>
                        ...
                        <b><?php 
                        $sql = $con->query("SELECT * FROM transaksi WHERE no_masuk = '$no_masuk'");
                        while($row = $sql->fetch_assoc()){
                        echo $row['user'];
                        } ?></b> 
                    </div>
