<?php
    ...
    if($_REQUEST['id_siswa']) {
        ...
        <font color=black>
            ...
            <div class="form-group">
                ...
                <tr>
                <td><label>No Penarikan</label></td>
                <td>&nbsp;</td>
    ...
    <hr/>
            <div class="form-group">
                ...
                <tr><td>
                <input class="form-control" name="keterangan" type="text" placeholder="Masukan Keterangan" required"> 
                </div>
                <h5 style="font-size:11px"><font color=red>* Keperluan Penarikan Saldo</font></h5>   
                </td>
                </td><td>&nbsp;</td>
                </tr>
                </table>
                ...
                <input type="submit" name="tpenarikan" value="Simpan" class="btn btn-primary">
