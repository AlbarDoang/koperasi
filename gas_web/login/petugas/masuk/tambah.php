      ...
      <?php include "../dashboard/menu.php"; ?>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                ...
                <form method="post" action="../masuk/" enctype="multipart/form-data" class="card">
                  <div class="card-body">
                  ...
                  <br>
                    <div class="form-group">
                      ...
                      <input type="date" name="tanggal" class="form-control" value="<?php echo $date; ?>" readonly>
                  ...
                  <div class="form-footer" align="center">
                    ...
                    <a href="../masuk/"><input value="Kembali" class="btn btn-danger" readonly="readonly"></a>
									</div>
                  <br>
                </form>
            </div>
